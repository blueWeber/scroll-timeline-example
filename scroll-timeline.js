  ...
  function D(e, t, n) {
    if (e.timeline) {
      ...
      z(e),
        ...
        'finished' == e.proxy.playState
          ? (e.finishedPromise || (e.finishedPromise = new M()),
            'pending' == e.finishedPromise.state &&
              (n
                ? O(e)
            ...
            ? ('idle' != this.playState &&
                ((function (e) {
                  e.pendingTask &&
                    ((e.pendingTask = null),
                    L(e),
                    e.readyPromise.reject(C()),
                    R(e),
                    e.readyPromise.resolve(e.proxy));
                })(e),
                e.finishedPromise &&
                  'pending' == e.finishedPromise.state &&
                  e.finishedPromise.reject(C()),
                (e.finishedPromise = new M()),
                e.animation.cancel()),
              (e.startTime = null),
              (e.holdTime = null),
        ...
        t(e, [
          ...
          },
          {
            ...
            get: function () {
              ...
              if (
                ...
                return 'paused';
              if (null != t) {
                if (e.animation.playbackRate > 0 && t >= V(e))
                  return 'finished';
          ...
          },
          {
            ...
            get: function () {
              ...
              return e.timeline
                ? (e.readyPromise ||
                    ((e.readyPromise = new M()), e.readyPromise.resolve(this)),
        ...
        (t.getViewTimelineOptions = function (e, t) {
          for (
            ...
            if (i.name == e) {
              ...
              if (r) return { subject: r, axis: i.axis };
            }
          }
          return null;
        }),
        ...
        e.target
          ...
          .forEach(function (t) {
            var n = (function (e, t) {
              ...
              if (!i) return null;
              var r =
                ee.getScrollTimelineOptions(i) ||
                ee.getViewTimelineOptions(i, t);
              return r
